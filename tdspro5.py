...
╠══════════════════════════════════════════════════════════════════════╣
║➢ Author   : 🌺NullSOFT🌺                                             ║
║➢ Youtube  : https://youtube.com/@_NullSOFT                           ║
║➣ Support  : https://fb.com/HoangDuy.user                             ║
║➣ Website Gạch Thẻ Cào  : https://NhantheNhanh.Com/                   ║
╚══════════════════════════════════════════════════════════════════════╝
"""
######[DEF AUTO]########
def echo(text):
...
def idelay(delaymin, delaymax):
	...
	for demtg in range(int(delay), -1, -1):
		print(trang+"["+xanh+"NullSOFT"+trang+"] ["+xanh+"L         "+trang+"] ["+xanh+str(demtg)+trang+"]",end="\r")
		sleep(0.1)
		print(trang+"["+cam+"NullSOFT"+trang+"] ["+cam+"L"+xanh+"O        "+trang+"] ["+cam+str(demtg)+trang+"]",end="\r")
		sleep(0.1)
		print(trang+"["+blue+"NullSOFT"+trang+"] ["+blue+"L"+xanh+"O"+cam+"A       "+trang+"] ["+blue+str(demtg)+trang+"]",end="\r")
		sleep(0.1)
		print(trang+"["+lam+"NullSOFT"+trang+"] ["+lam+"L"+xanh+"O"+cam+"A"+blue+"D      "+trang+"] ["+lam+str(demtg)+trang+"]",end="\r")
		sleep(0.1)
		print(trang+"["+tim+"NullSOFT"+trang+"] ["+tim+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I     "+trang+"] ["+tim+str(demtg)+trang+"]",end="\r")
		sleep(0.1)
		print(trang+"["+xnhac+"NullSOFT"+trang+"] ["+xnhac+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N    "+trang+"] ["+xnhac+str(demtg)+trang+"]",end="\r")
		sleep(0.1)
		print(trang+"["+den+"NullSOFT"+trang+"] ["+den+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G   "+trang+"] ["+den+str(demtg)+trang+"]",end="\r")
		sleep(0.1)
		print(trang+"["+do+"NullSOFT"+trang+"] ["+do+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G.  "+trang+"] ["+do+str(demtg)+trang+"]",end="\r")
		sleep(0.2)
		print(trang+"["+vang+"NullSOFT"+trang+"] ["+vang+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G.. "+trang+"] ["+vang+str(demtg)+trang+"]",end="\r")
		sleep(0.3)
		print(trang+"["+vang+"NullSOFT"+trang+"] ["+vang+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G..."+trang+"] ["+vang+str(demtg)+trang+"]",end="\r")
