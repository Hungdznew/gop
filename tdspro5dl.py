...
def idelay(delaymin, delaymax):
	...
	for demtg in range(int(delay), -1, -1):
		print(trang+"["+xanh+"🏵️ NullSOFT 🏵️"+trang+"] ["+xanh+"L         "+trang+"] ["+xanh+str(demtg)+trang+"]",end="     \r")
		sleep(0.1)
		print(trang+"["+cam+"🏵️ NullSOFT 🏵️"+trang+"] ["+cam+"L"+xanh+"O        "+trang+"] ["+cam+str(demtg)+trang+"]",end="     \r")
		sleep(0.1)
		print(trang+"["+blue+"🏵️ HDT - TOOL 🏵️"+trang+"] ["+blue+"L"+xanh+"O"+cam+"A       "+trang+"] ["+blue+str(demtg)+trang+"]",end="     \r")
		sleep(0.1)
		print(trang+"["+lam+"🏵️ NullSOFT 🏵️"+trang+"] ["+lam+"L"+xanh+"O"+cam+"A"+blue+"D      "+trang+"] ["+lam+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+tim+"🏵️ NullSOFT 🏵️"+trang+"] ["+tim+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I     "+trang+"] ["+tim+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+xnhac+"🏵️ NullSOFT 🏵️"+trang+"] ["+xnhac+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N    "+trang+"] ["+xnhac+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+den+"🏵️ NullSOFT 🏵️"+trang+"] ["+den+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G   "+trang+"] ["+den+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+do+"🏵️ NullSOFT 🏵️"+trang+"] ["+do+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G.  "+trang+"] ["+do+str(demtg)+trang+"]",end="     \r")
		sleep(0.2)
		print(trang+"["+vang+"🏵️ NullSOFT 🏵️"+trang+"] ["+vang+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G.. "+trang+"] ["+vang+str(demtg)+trang+"]",end="       \r")
		sleep(0.2)
		print(trang+"["+vang+"🏵️ NullSOFT 🏵️"+trang+"] ["+vang+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G..."+trang+"] ["+vang+str(demtg)+trang+"]",end="      \r")
	print(trang+" ĐANG LÀM JOB TDS", end="                             \r")
def idelayblock(delay):
	for demtg in range(int(delay), -1, -1):
		print(trang+"["+xanh+"🏵️ NullSOFT 🏵️"+trang+"] ["+xanh+"L         "+trang+"] [TIME_BLOCK] ["+xanh+str(demtg)+trang+"]",end="     \r")
		sleep(0.1)
		print(trang+"["+cam+"🏵️ NullSOFT 🏵️"+trang+"] ["+cam+"L"+xanh+"O        "+trang+"] [TIME_BLOCK] ["+cam+str(demtg)+trang+"]",end="     \r")
		sleep(0.1)
		print(trang+"["+blue+"🏵️ NullSOFT 🏵️"+trang+"] ["+blue+"L"+xanh+"O"+cam+"A       "+trang+"] [TIME_BLOCK] ["+blue+str(demtg)+trang+"]",end="     \r")
		sleep(0.1)
		print(trang+"["+lam+"🏵️ NullSOFT 🏵️"+trang+"] ["+lam+"L"+xanh+"O"+cam+"A"+blue+"D      "+trang+"] [TIME_BLOCK] ["+lam+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+tim+"🏵️ NullSOFT 🏵️"+trang+"] ["+tim+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I     "+trang+"] [TIME_BLOCK] ["+tim+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+xnhac+"🏵️ NullSOFT 🏵️"+trang+"] ["+xnhac+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N    "+trang+"] [TIME_BLOCK] ["+xnhac+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+den+"🏵️ NullSOFT 🏵️"+trang+"] ["+den+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G   "+trang+"] [TIME_BLOCK] ["+den+str(demtg)+trang+"]",end="    \r")
		sleep(0.1)
		print(trang+"["+do+"🏵️ NullSOFT 🏵️"+trang+"] ["+do+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G.  "+trang+"] [TIME_BLOCK] ["+do+str(demtg)+trang+"]",end="     \r")
		sleep(0.2)
		print(trang+"["+vang+"🏵️ NullSOFT 🏵️"+trang+"] ["+vang+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G.. "+trang+"] [TIME_BLOCK] ["+vang+str(demtg)+trang+"]",end="       \r")
		sleep(0.2)
		print(trang+"["+vang+"🏵️ NullSOFT 🏵️"+trang+"] ["+vang+"L"+xanh+"O"+cam+"A"+blue+"D"+lam+"I"+tim+"N"+xnhac+"G..."+trang+"] [TIME_BLOCK] ["+vang+str(demtg)+trang+"]",end="      \r")
	print(trang+" ĐANG LÀM JOB TDS", end="                             \r")
def LoadJob(delay):
...
def NhapTds():
	while True:
		if os.path.exists('GioiTool_TokenTDS.txt'):
			with open('GioiTool_TokenTDS.txt', 'r') as f:
			...
			if chon == '1':
				...
				os.remove('GioiTool_TokenTDS.txt'); khang(34)
			else:
				print(do+'LỰA CHỌN KHÔNG XÁC ĐỊNH.'); khang(34); continue
		if not os.path.exists('GioiTool_TokenTDS.txt'):
			while True:
				khang(34)
				...
				if "error" in login:
					...
					user = login["user"]
					with open('GioiTool_TokenTDS.txt', 'w') as f:
...
def success(dem, id, type, msg, xu):
	...
	echo(f"{luc}[{vang}{dem}{luc}]{trang} <|> {xnhac}{time}{trang} <|> {luc}{type}{trang} <|> {xnhac}NO ID{trang} <|> +{luc}{msg}{trang} <|> {luc}{str(format(int(xu), ','))} Xu")
def error(id, type, dem):
	time=datetime.now().strftime("%H:%M:%S")
	uid = id.split('_')[1] if '_' in id else id
	print(f'{do}[{vang}{dem}{do}] <|>{time} <|> {type} <|> {uid} <|> ERROR', end = '          \r'); sleep(2); print('                                                   ', end = '\r')
def NhapCookieFb():
	list = []
	z = 0
	khang(34)
...
def LuuCookie():
	while True:
		if os.path.exists('GIOITOOL_CokieFB.txt'):
			...
			chon = input(edit+'VUI LÒNG NHẬP LỰA CHỌN: '+trang)
			if chon == '1':
				with open('GIOITOOL_CokieFB.txt', 'r') as f:
					list = json.loads(f.read())
					break
			elif chon == '2':
				os.remove('GIOITOOL_CokieFB.txt'); khang(34)
			else:
				print(do+'LỰA CHỌN KHÔNG XÁC ĐỊNh.'); khang(34); continue
		if not os.path.exists('GIOITOOL_CokieFB.txt'):
			list = NhapCookieFb()
			with open('GIOITOOL_CokieFB.txt', 'w') as f:
				json.dump(list, f)
			break
	return list
def main():
  ...
  #banner()
	...
	print(edit+'SAU        '+luc+'NHIỆM VỤ THÌ KÍCH HOẠT CHỐNG BLOCK.',end='\r')
	nvblock = int(input(edit+'Sau '+trang))
	print(f'{edit}SAU {nvblock} NHIỆM VỤ NGHỈ NGƠI        {luc}GIÂY       ',end='\r')
	...
	while True:
		if len(listck) == 0:
			...
			listck = NhapCookieFb()
			with open('Drg-Cookie-Page-Fb-tds.txt', 'w') as f:
				json.dump(listck, f)
		with open('Drg-Cookie-Page-Fb-tds.txt', 'w') as f:
			json.dump(listck, f)
		for cookie in listck:
			...
			try:
				...
				listck.remove(cookie)
				os.remove('Drg-Cookie-Page-Fb-tds.txt')
main()
